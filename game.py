...
def msgSurface(text):
    ...
    titleTextSuf, titleTextRect = makeTextObjs(text, largeText)
    titleTextRect.center = surfaceWidth/2, surfaceHeight/2
    surface.blit(titleTextSuf, titleTextRect)

    typTextSuf, typTextRect = makeTextObjs("Press any key to continue", smallText)
    typTextRect.center = surfaceWidth/2, ((surfaceHeight/2) + 100)
    surface.blit(typTextSuf, typTextRect)
